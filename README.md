# Build environment for TDA2 Linux
...
Here tag can be zm-tda2-linux. Typically, you can map /home in host to /home in docker, then, you can add group and user as the same as host before you build the source:
